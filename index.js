...
app.post('/api/pair', async (req, res) => {
    ...
    try {
        ...
        const code = await globalSock.requestPairingCode(phone.trim());        pairingCode = code;
...
async function startBot() {
    ...
    const sock = makeWASocket({
        ...
        auth: state,        generateHighQualityLinkPreview: true
    });
    ...
    // Anti-Delete, Anti-ViewOnce, elatriye (menm kòd anvan an)
